        ...
        <div className="text-center mt-6">
          <a href="/commwall">
            <button
              ...
              className="bg-gradient-to-r from-[#7c4a36] to-[#a67c52] text-white px-6 py-3 rounded-full font-bold text-lg transition-all duration-200 hover:bg-[#4b2f25] hover:scale-105 shadow-lg"
            >
              Visit Wall
            </button>
          </a>
